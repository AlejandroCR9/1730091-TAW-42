<?php
  ...
  $Id=$_POST["id"];
  $sql="SELECT idDulce, nombre, precio, monedas FROM dulceria WHERE idDulce = '$Id'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Modificar dulce</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="id" value=<?php print_r($reg["idDulce"]); ?>>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="number" class="form-control" id="precio" name="precio" value=<?php print_r($reg["precio"]); ?> required>
                    </div>
                </div>
