      ...
      ?>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div>
                <form class="user" method="POST" action="panel-venta.php">
                  <div class="form-group row">
                    <div class="col-sm-4" style="margin-right:50px;">
                      <label for="gamer">Realizar venta a</label>
                      <!--<input type="date" class="form-control" id="fecha" name="fecha">-->
                      <select name="gamer" id="gamer" class="form-control">
                      <?php $query = $mysqli -> query ("SELECT idUsuario, gamerTag FROM usuarios");
                        while ($valores = mysqli_fetch_array($query)) {
                          if (!($reg["gamer"]==$valores[gamerTag])) {
