...
$sql = "UPDATE accesorios SET idConsola = '$Cons', descripcion = '$Descr', unidades = '$uni', preciorenta = $prenta WHERE idAccesorio ='$Id'";
if(mysqli_query($conn,$sql)){
    echo '<script>alert("Accesorio modificado")</script>';
