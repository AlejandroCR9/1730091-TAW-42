    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Modificar renta</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <?php
            $Id=$_POST["id"];
            $sql="SELECT r.idRenta AS idRenta, r.fecha AS fecha, r.hora AS hora, r.tiempo AS hrsjugadas, r.idConsola AS idConsola, r.idGamer AS idGamer, u.gamerTag AS gTag,  r.total AS total, u.monedas AS monedas FROM renta r INNER JOIN usuarios u ON r.idGamer = u.idUsuario AND r.idRenta = '$Id'";
            $datos=mysqli_query($conn,$sql);
            $reg=mysqli_fetch_array($datos);
            ?>
            <form class="user" method="POST" action="sqleditar.php">
            <input type="hidden" name="id" value=<?php print_r($reg["idRenta"]); ?>>
                <div class="form-group row">
                    <div class="col-sm-2">
                  
                      <input type="text" class="form-control" id="fecha" name="fecha" value=<?php print_r($reg["fecha"]); ?>  readonly required>
                    </div>
                    <div class="col-sm-2">
                     
                      <input type="text" class="form-control" id="hora" name="hora" value=<?php print_r($reg["hora"]); ?> required>
                    </div>                  
                </div>
                <div class="form-group row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-2">
                      ...
                      <input type="text" class="form-control" id="monedas" name="monedas" value=<?php print_r($reg["monedas"]); ?> required>
                    </div> 
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="col-sm-2">
                      ...
                      <input type="text" class="form-control" id="total" name="total" value=<?php echo $reg["total"] ?> readonly required>
                    </div> 
                </div>
