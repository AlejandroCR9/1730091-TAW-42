    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Registrar consola</h1>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                      ...
                      <input type="number" class="form-control" id="numero" min=0 name="numero" required>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="number" class="form-control"  min=0 value=0 id="preciohra" name="preciohra" hidden>
                    </div>
                </div>
