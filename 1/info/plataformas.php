                    ...
                    <div class="content ">
                        <section class="no-padding no-border">
                            ...
                            <div class="fixed-info-container">
                                ...
                                <div class="filter-holder filter-vis-column">
                                    <div class="gallery-filters">
                                        ...
                                        <a href="plataformas.php" class="gallery-filter gallery-filter-active">Plataformas</a>
                            ...
                            <div class="resize-carousel-holder vis-info">
                                ...
                                <?php foreach ($conn->query('SELECT nombre, monedasganadas, SUBSTRING(rutaImagen, 4) AS imagen FROM plataformas ') as $row){ ?>
                                    <!-- 1 -->
                                            ...
                                            <div class="box-item">
                                                <div class="wh-info-box">
                                                    <div class="wh-info-box-inner at">
                                                        ...
                                                        <span class="folio-cat">Gana <?php echo $row['monedasganadas'] ?> x hr</span>
                                                    </div>
                                                </div>
