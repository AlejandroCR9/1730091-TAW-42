                    ...
                    <div class="content ">
                        <section class="no-padding no-border">
                            ...
                            <div class="fixed-info-container">
                                ...
                                <div class="filter-holder filter-vis-column">
                                    <div class="gallery-filters">
                                        ...
                                        <a href="torneos.php" class="gallery-filter gallery-filter-active">Torneos</a>
                            ...
                            <div class="resize-carousel-holder vis-info">
                                ...
                                <?php foreach ($conn->query('SELECT titulo, fecha, SUBSTRING(rutaImagen, 4) AS imagen FROM torneos ') as $row){ ?>
                                    <!-- 1 -->
                                            ...
                                            <div class="box-item">
                                                <div class="wh-info-box">
                                                    <div class="wh-info-box-inner at">
                                                        ...
                                                        <span class="folio-cat">Fecha: <?php echo $row['fecha'] ?></span>
                                                    </div>
                                                </div>
