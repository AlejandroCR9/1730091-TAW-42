    ...
    export default {
        ...
        computed:{
            ...
            parametersTable1(){
                return {
                    ...
                    actions: ["delete"], //Acciones que tendra el datatable
        ...
        methods: { 
            cargar(){
                ...
                let uri = `http://161.35.13.32/Alex/1730091-TAW-42/expedientes/public/api/miscompartidos/${this.$cookies.get('id')}`;
