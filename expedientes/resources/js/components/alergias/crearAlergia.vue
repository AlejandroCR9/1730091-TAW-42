    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Alergias
                            <div class="page-title-subheading">Esta registrando una nueva alergia.
                            </div>
                        </div>
                    </div>    
                </div>
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <h5 class="card-title">Crear nueva alergia</h5>
                    <form class="needs-validation" @submit.prevent="addAlergia">
                        <div class="form-row">
