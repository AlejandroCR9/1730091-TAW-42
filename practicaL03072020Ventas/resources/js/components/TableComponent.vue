                       ...
                       <tr>
                        ...
                        <tr v-for="producto in productos" :key="producto.id"> <!--Recorremos el array y cargamos nuestra tabla-->
                            ...
                            <td>
                               ...
                               <button class="btn btn-danger" @click.prevent="deleteProducto(producto.id)">Borrar</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<script>
    export default {
      ...
      created() {
      let uri = 'http://localhost/tecnologias/1730091-TAW-42/practicaL03072020Ventas/public/index.php/api/producto';
    ...
    methods: {
      deleteProducto(id)
      {
        let uri = 'http://localhost/tecnologias/1730091-TAW-42/practicaL03072020Ventas/public/index.php/api/producto/delete/'+id;
