<?php 
	...
	/*Llamada a los controladres para insertar/modificar/eliminar cliientes*/
	...
	}else if(isset($_GET['idClientEditar'])){
...
<div class="container-fluid">
	...
	<div class="card card-secondary">
		...
		<div class="card-body">
			<div class="row mb-4">
				<div class="col-sm-6">
					<a href="index.php?action=clientes&registar" class="btn btn-info">Agregar Cliente</a>
				</div>
			</div>
						...
						<table id="example1" class="table table-hover m-0 table-bordered">
							...
							<tbody>
								<?php 
									...
									$clientes->vistaClienteController();
								?>
							</tbody>
						</table>	
					</div>
